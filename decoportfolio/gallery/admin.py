...
class BusinessInfoAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Company Information", {"fields": ("company_name", "tagline", "description")}),
        ("Contact Information", {"fields": ("email", "phone", "address")}),
        ("Business Details", {"fields": ("years_experience", "specialties")}),
...
class PortfolioItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Project Details", {"fields": ("is_before_after",)}),
        ("Organization", {"fields": ("category", "service")}),
